...
irr_err_sequence={"txt":"!!Irr sequence <{:}> has unknown irrigation points <{:}>", "descr":"","cat":"Irrigation_manager"}
...
msg_ws_connect={"txt":"WS_server: {:} is connected {:}", "descr":"","cat":"Things_sync"}
msg_ws_reject={"txt":"WS_server: {:} is rejected {:}", "descr":"","cat":"Things_sync"}
msg_ws_closed={"txt":"WS_server: {:} is closed {:}", "descr":"","cat":"Things_sync"}
...
err_pix_drivers={"txt":"!!Pixtend drivers for <{}> not installed!", "descr":"","cat":"Pixtend_driver"}
err_pix_spi={"txt":"!!Pixtend SPI for <{}> not working", "descr":"","cat":"Pixtend_driver"}
err_pix_path={"txt":"!!Pixtend <{}> / thing <{}> {}", "descr":"","cat":"Pixtend_driver"}
...
err_sma_type={"txt":"!!Sma {} is <{}> type but should be {}", "descr":"","cat":"Sma_driver"}
err_sma_bad={"txt":"!!Sma {} does not access : {}", "descr":"","cat":"Sma_driver"}
err_sma_dev={"txt":"!!Sma {} has {} not in {}", "descr":"","cat":"Sma_driver"}
err_sma_ns={"txt":"!!Sma {} not yet supported", "descr":"","cat":"Sma_driver"}
