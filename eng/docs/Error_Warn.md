...
err_ws_issue={"txt":"!!WS_server: crash of <{:}> {:}", "descr":"","cat":"Things_sync"}
msg_ws_c_connect={"txt":"WS_client: {:} is connected", "descr":"","cat":"Things_sync"}
msg_ws_c_closed={"txt":"WS_client: {:} is closed", "descr":"","cat":"Things_sync"}
err_ws_c_issue={"txt":"!!WS_client: crash of <{:}> {:}, sending {:}", "descr":"","cat":"Things_sync"}
