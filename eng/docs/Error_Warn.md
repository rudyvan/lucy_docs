...
err_item_cumul={"txt":"!!{:} ?tc for cumul request", "descr":"","cat":"Things_forensics"}
msg_cum_flip={"txt":"Cumuls {:}", "descr":"","cat":"Things_forensics"}
msg_cum_new_day_done={"txt":"Cumul New Day resets of all tcs is completed", "descr":"","cat":"Things_forensics"}
err_cum_reply={"txt":"!!{:} replied for {:}?? with cumul {:}", "descr":"","cat":"Things_forensics"}
err_cum_req={"txt":"!!{:} wanted cumul {:}??", "descr":"","cat":"Things_forensics"}
err_cumul={"txt":"!!Cumul internal error for <{:}> with {:} not in {:}", "descr":"","cat":"Things_forensics"}
err_cum_owner={"txt":"!!Cumul request failed, no tc for <{:}>", "descr":"","cat":"Things_forensics"}
msg_cum_self={"txt":"cum <{:}> i have myself", "descr":"","cat":"Things_forensics"}
msg_cum_request={"txt":"cum <{:}> requested from {:}/{:}", "descr":"","cat":"Things_forensics"}
msg_cum_reply={"txt":"cum <{:}> reply from {:}/{:}", "descr":"","cat":"Things_forensics"}
...
err_out_val={"txt":"!!Output Dissonance Unipi <{:}>, thing <{:}>, val={:}, unipi={:}", "descr":"","cat":"Things_additions"}
...
msg_virtual_only_when={"txt":"Virtual <{:}> prevented <{:}.mk_active()> with <{:}>", "descr":"","cat":"Virtual"}
...
err_ssi_secret={"txt":"!!web_secret missing in things_forensics", "descr":"","cat":"Ifttt_driver"}
