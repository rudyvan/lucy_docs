...
paths_used={'_:PI-Climate': 'gas_heater^carbon_copy,gas_heater,hot_water_tank,%vent,pump^on_off_relay,pump,pool_pump',
	 '_:PI-Energy': 'electricity^car_battery^occupancy,rain_water^tank_outflow,rain_water^irrigation',
	 '_:PI-Pool': 'irr5_rev_clockwise,irr6_clockwise,irr_flow_meter,irr_water_supply,rain_water^rain_tank^availability,ground_water^irrigation,waste_water^waste_tank^availability',
	 ...
	 'unipi:PI-RearDoor,relay,3': 'garage_rear_door^pulse2open,rain_water^rain_tank^output_1',
	 'unipi:PI-RearDoor,relay,4': 'rain_water^rain_tank^output_2',
	 ...
	 'usb:PI-Soccer,serial_arduino,a,0': 'rain_water^rain_tank^monitor',
