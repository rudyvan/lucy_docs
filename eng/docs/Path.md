...
paths_used={'_:PI-Climate': 'gas_heater^carbon_copy,gas_heater,hot_water_tank,%vent,pump^on_off_relay,pump,pool_pump',
	 ...
	 'unipi:PI-Pool,input,5': 'rain_water^rain_tanks_1_2^drain_out^vfy_same_delayed:10',
	 'unipi:PI-Pool,input,6': 'irr5_rev_clockwise^vfy_same_delayed:10',
	 'unipi:PI-Pool,input,7': 'irr6_clockwise^vfy_same_delayed:10',
