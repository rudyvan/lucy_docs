...
paths_used={'_:PI-Climate': 'gas_heater^carbon_copy,gas_heater,hot_water_tank,%vent,pump^on_off_relay,pump,pool_pump',
	 ...
	 'unipi:PI-Pool,ai,0': 'rain_water^rain_tanks_1_2^availability',
	 'unipi:PI-Pool,ai,1': 'rain_water^rain_tank_3^availability',
	 ...
	 'unipi:PI-RearDoor,relay,3': 'garage_rear_door^pulse2open,rain_water^rain_tanks_1_2^output_1',
