...
paths_used={'_:PI-Climate': 'gas_heater^carbon_copy,gas_heater,hot_water_tank,%vent,pump^on_off_relay,pump,pool_pump',
	 ...
	 'unipi:PI-Climate,input,10': 'Pool_valve^check_state:10',
	 ...
	 'unipi:PI-Climate,input,9': 'CV_valve^check_state:10',
	 ...
	 'unipi:PI-Pool,input,4': 'irr_water_supply^check_state:10',
	 'unipi:PI-Pool,input,5': 'rain_water^rain_tanks_1_2^drain_out^check_state:10',
	 'unipi:PI-Pool,input,6': 'irr5_rev_clockwise^check_state:10',
	 'unipi:PI-Pool,input,7': 'irr6_clockwise^check_state:10',
